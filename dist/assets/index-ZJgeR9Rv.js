...
const Fv = {
  ...
  Wv = {
    ...
    recognition: {
      0: "ELLE O‘zbekiston , молодая художница года (2025)",
      1: "Cafb.Asia, От рук ремесленников к объятиям природы. Узбекское искусство в гармонии с принципами устойчивого развития. (2025)",
      2: "Награда молодого художника, The Mag (2022)",
      label: "Достижения",
    },
  },
  Kv = {
